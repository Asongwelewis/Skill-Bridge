...
export default function Sidebar() {
  ...
  return (
    <aside
      className="flex flex-col h-screen sticky top-0 shrink-0 theme-transition"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-5"
        ...
        <div className="w-9 h-9 rounded-xl bg-indigo-600 flex items-center justify-center shrink-0 shadow-lg shadow-indigo-900/40">
