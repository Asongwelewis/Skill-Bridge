...
const STATUS_CFG = {
  ...
  active:    { label: 'Live Now',  textColor: '#34d399', bg: 'rgba(16,185,129,0.12)', border: 'rgba(16,185,129,0.3)', Icon: Video },
                ...
                <Link to={`/session/${session._id}`}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <p className="font-semibold truncate">{session.topic || 'Learning Session'}</p>
                      {isLive && (
