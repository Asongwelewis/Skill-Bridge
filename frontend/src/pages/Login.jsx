...
import { Brain, Mail, Lock, Eye, EyeOff, Sun, Moon, Sparkles, ArrowRight } from 'lucide-react'
    ...
    <div className="h-screen theme-transition overflow-hidden" style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <div className="relative z-10 grid h-screen grid-cols-1 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="hidden lg:flex flex-col justify-between p-10 xl:p-12">
          {/* Brand panel: pinned to a dark glass gradient in BOTH themes so the
              white text always reads (light mode would otherwise be invisible). */}
          <div className="glass-panel card-3d h-full p-8 xl:p-10 relative overflow-hidden"
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute top-16 right-10 h-52 w-52 rounded-full blur-3xl animate-slow-float"
                style={{ background: 'radial-gradient(circle, rgba(79,70,229,0.18) 0%, transparent 70%)' }} />
              <div className="absolute bottom-14 left-8 h-44 w-44 rounded-full blur-3xl animate-slow-float"
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div>
                ...
                <p className="max-w-md text-white/65 leading-relaxed mb-8">
                  Jump straight back into your learning workspace — sessions, matches, and skills all in one calm view.
                </p>

                <div className="grid gap-3 max-w-md">
                  {['Resume where you left off', 'Check pending matches', 'Join your next session'].map((text) => (
                    <div key={text} className="glass-chip justify-start">
              ...
              <div className="grid grid-cols-3 gap-3 max-w-md">
                {[
                  ...
                  { value: 'Live', label: 'Sessions ready' },
                  { value: 'Fast', label: 'Match flow' },
                ].map(item => (
        ...
        <section className="relative flex items-center justify-center px-5 py-8 md:px-8 overflow-y-auto">
          <button
            onClick={toggleTheme}
          ...
          <div className="w-full max-w-md">
            <div className="glass-panel card-3d p-6 md:p-7">
              ...
              <h1 className="text-2xl md:text-3xl font-semibold mb-2">Sign in to your account</h1>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <Mail size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: 'var(--text-subtle)' }} />
                    <input
                      type="email"
                      value={email}
